"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5947],{
...
// EXTERNAL MODULE: ../../libs/app/model/src/index.ts
var src = __webpack_require__(65180);
...
// EXTERNAL MODULE: ../../libs/im/matrix/src/index.ts + 366 modules
var matrix_src = __webpack_require__(2078);
...
function InviteContactDialog(param) {
    ...
    const [accessToken] = (0,useProxyWatch/* useProxyWatch */.x)(matrix_src/* matrixUser */.xb.userData.userInfo, 'loginResponse.access_token', (_matrixUser_userData_userInfo_loginResponse = matrix_src/* matrixUser */.xb.userData.userInfo.loginResponse) === null || _matrixUser_userData_userInfo_loginResponse === void 0 ? void 0 : _matrixUser_userData_userInfo_loginResponse.access_token);
    ...
    const executeApiCall = (0,react.useCallback)(async (params)=>{
        ...
        try {
            ...
            const res = await (0,src.tmsEmcInviteContacts)({
                params,
                handler: {
                    printLog: true
                }
    ...
    const fetchCallTypes = (0,react.useCallback)(async ()=>{
        ...
        const res = await (0,src.tmsEmcGetContactTypes)({
            params: {},
            handler: {
                printLog: true
            }
    ...
    const handleSendInvitation = (0,react.useCallback)(async ()=>{
        ...
        const currentAccessToken = (_matrixUser_userData_userInfo_loginResponse = matrix_src/* matrixUser */.xb.userData.userInfo.loginResponse) === null || _matrixUser_userData_userInfo_loginResponse === void 0 ? void 0 : _matrixUser_userData_userInfo_loginResponse.access_token;
        const params = {
...
const PendingInvitationsList = ()=>{
    ...
    (0,react.useEffect)(()=>{
        const unsub = matrix_src/* matrixClient */.Xi.imDispatcher.addListener(matrix_src/* matrixClient */.Xi.ImDispatcherEventTypes.INVITE, ()=>{
            if (!userToken) return;
            loadPendingInvitations();
        });
        return unsub;
...
var AddComment = __webpack_require__(54196);
...
;// ./src/components/report/ReportButton/index.tsx
 ...
 */ const ReportButton = (param)=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(ReportSubmitModal, {
                open: modalOpen,
...
const EmergencyTTSSettings = ()=>{
    ...
    async function onRecordClick() {
        if (User/* user */.k.data.storeData.user_token) {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Dialog/* default */.A, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogActions/* default */.A, {
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(ReportButton, {}),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Grid2/* default */.A, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                        size: 6,
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(TestEmergencyCall, {})
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                        size: 6,
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
