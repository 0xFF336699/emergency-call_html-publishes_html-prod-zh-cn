...
if (true) {
    ...
    checkDCE();
    module.exports = __webpack_require__(19119);
} else {}
...
if (true) {
    ...
    // DevTools can report bad minification during injection.
    checkDCE();
    module.exports = __webpack_require__(61975);
} else {}
...
*/ 
var Scheduler = __webpack_require__(59950), React = __webpack_require__(94285), ReactDOM = __webpack_require__(9293);
function formatProdErrorMessage(code) {
    var url = "https://react.dev/errors/" + code;
    if (1 < arguments.length) {
        url += "?args[]=" + encodeURIComponent(arguments[1]);
...
//# sourceMappingURL=framework-6ddfb40f04d362f0.js.map