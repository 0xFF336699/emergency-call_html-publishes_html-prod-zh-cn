"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[9093],{
...
function InviteContactDialog_InviteContactDialog(param) {
    ...
    const [accessToken] = useProxyWatch(matrixUser.userData.userInfo, 'loginResponse.access_token', (_matrixUser_userData_userInfo_loginResponse = matrixUser.userData.userInfo.loginResponse) === null || _matrixUser_userData_userInfo_loginResponse === void 0 ? void 0 : _matrixUser_userData_userInfo_loginResponse.access_token);
    ...
    const executeApiCall = useCallback(async (params)=>{
        ...
        try {
            ...
            if (successResults.length > 0) {
                toast.success("成功邀请 ".concat(successResults.length, " 个联系人"));
    ...
    const handleSendInvitation = useCallback(async ()=>{
        ...
        for (const input of contactInputs){
            if (isValidIdentity(input)) {
                ...
                toast.error("联系人格式无效: ".concat(input, "。必须是11位手机号或32位字符串。"));
                return;
            }
        }
        ...
        const currentAccessToken = (_matrixUser_userData_userInfo_loginResponse = matrixUser.userData.userInfo.loginResponse) === null || _matrixUser_userData_userInfo_loginResponse === void 0 ? void 0 : _matrixUser_userData_userInfo_loginResponse.access_token;
        const params = {
                            ...
                            renderInput: (params)=>/*#__PURE__*/ _jsx(TextField, {
                                    ...
                                    InputProps: {
                                        ...
                                        endAdornment: /*#__PURE__*/ _jsxs(_Fragment, {
                                            children: [
                                                isTypesLoading ? /*#__PURE__*/ _jsx(CircularProgress, {
                                                    color: "inherit",
                                                    size: 20
                                                }) : null,
...
var Tooltip_Tooltip = __webpack_require__(77779);
