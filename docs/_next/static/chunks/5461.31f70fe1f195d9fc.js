(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5461],{
...
var tslib_1 = __webpack_require__(29403);
var common_1 = __webpack_require__(5321);
var shallowequal_1 = tslib_1.__importDefault(__webpack_require__(94104));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tslib_1 = __webpack_require__(29403);
var react_1 = __webpack_require__(94285);
var Component = /** @class */ (function (_super) {
    ...
    Component.prototype.getMap = function () {
        // @ts-ignore
        return this.props.map || this.context.map;
    };
    Component.prototype.getInstance = function (component) {
        return component.instance;
    };
    Component.prototype.getOptions = function (props) {
        if (props === void 0) { props = this.props; }
        var options = {};
        this.options.map(function (key) {
...
var tslib_1 = __webpack_require__(29403);
var common_1 = __webpack_require__(5321);
var WrapperHOC_1 = tslib_1.__importDefault(__webpack_require__(18004));
var shallowequal_1 = tslib_1.__importDefault(__webpack_require__(94104));
var Map_1 = __webpack_require__(89270);
...
var Marker = /** @class */ (function (_super) {
    ...
    Marker.prototype.componentDidUpdate = function (prevProps) {
        ...
        var _a = this.props, position = _a.position, icon = _a.icon, autoViewport = _a.autoViewport, offset = _a.offset, isTop = _a.isTop, rotation = _a.rotation;
        var prePosition = prevProps.position, preIcon = prevProps.icon, preViewport = prevProps.autoViewport, preOffset = prevProps.offset, preTop = prevProps.isTop, preRotation = prevProps.rotation;
        var isDataChanged = position && !shallowequal_1.default(position, prePosition);
        var isRotationChanged = rotation && !shallowequal_1.default(rotation, preRotation);
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
var react_dom_1 = __webpack_require__(9293);
/**
 * 自定义覆盖物的DOM生成类
 * @param point 定位点坐标
...
function CustomOverlayDom(point, options) {
    ...
    // 添加更新方法
    this.setPoint = function (point, noReCreate) {
        this._point = new BMapGL.Point(point.lng, point.lat);
        this.draw();
    };
    ...
    this.setRotationOrigin = function (origin) {
        if (this._div) {
...
CustomOverlayDom.prototype.initialize = function (map) {
    ...
    var pane = this._options.fixBottom ?
...
CustomOverlayDom.prototype.draw = function () {
    ...
    // 计算偏移
    var anchors = this._options.anchors || [0.5, 1];
    var offsetX = this._options.offsetX || 0;
    var offsetY = this._options.offsetY || 0;
    // 计算位置
    var left = pixel.x - (this._div.offsetWidth * anchors[0]) + offsetX;
    var top = pixel.y - (this._div.offsetHeight * anchors[1]) + offsetY;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var WrapperHOC_1 = __webpack_require__(18004);
Object.defineProperty(exports, "Wrapper", ({ enumerable: true, get: function () { return WrapperHOC_1.default; } }));
var Component_1 = __webpack_require__(1062);
...
Object.defineProperty(exports, "getDisplayName", ({ enumerable: true, get: function () { return getDisplayName_1.default; } }));
...
var common_1 = __webpack_require__(5321);
var shallowequal_1 = tslib_1.__importDefault(__webpack_require__(94104));
var CustomOverlayDom_1 = tslib_1.__importDefault(__webpack_require__(4885));
var Map_1 = __webpack_require__(89270);
/**
 * 在地图上通过传入DOM添加自定义覆盖物
...
var CustomOverlay = /** @class */ (function (_super) {
    ...
    CustomOverlay.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (this.overlay) {
            ...
            // 检查点位变化
            if (!shallowequal_1.default(this.props.point, prevProps.point)) {
            ...
            // 检查属性变化
            if (!shallowequal_1.default(this.props.properties, prevProps.properties)) {
            ...
            var needRecreate = updateKeys.some(function (key) {
                return !shallowequal_1.default(_this.props[key], prevProps[key]);
            });
            if (needRecreate) {
                this.initialize();
            }
    ...
    CustomOverlay.prototype.initialize = function () {
        ...
        // @ts-ignore
        this.overlay = new CustomOverlayDom_1.default(point, tslib_1.__assign(tslib_1.__assign({}, this.getOptions()), { html: this.props.children }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tslib_1 = __webpack_require__(29403);
var Graphy_1 = tslib_1.__importDefault(__webpack_require__(22301));
var shallowequal_1 = tslib_1.__importDefault(__webpack_require__(94104));
;
/**
 * 在地图上绘制简单的圆形
...
var tslib_1 = __webpack_require__(29403);
// @ts-ignore
var mapvgl = tslib_1.__importStar(__webpack_require__(53020));
// @ts-ignore
var mapvglThree = tslib_1.__importStar(__webpack_require__(27520));
var common_1 = __webpack_require__(5321);
var MapvglView_1 = __webpack_require__(35575);
;
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tslib_1 = __webpack_require__(29403);
var Control_1 = tslib_1.__importDefault(__webpack_require__(310));
/**
 * 比例尺控件，默认位于地图左下角
 * @visibleName ScaleControl 比例尺控件
 */
var ScaleControl = /** @class */ (function (_super) {
    tslib_1.__extends(ScaleControl, _super);
    function ScaleControl(props) {
        return _super.call(this, props) || this;
    }
    ScaleControl.prototype.getControl = function () {
...
var tslib_1 = __webpack_require__(29403);
// @ts-ignore
var mapvgl_1 = __webpack_require__(53020);
var react_1 = tslib_1.__importStar(__webpack_require__(94285));
var common_1 = __webpack_require__(5321);
var Map_1 = __webpack_require__(89270);
;
...
var Label = /** @class */ (function (_super) {
    ...
    Label.prototype.destroy = function () {
        if (this.label && this.map && !this.map._destroyed) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tslib_1 = __webpack_require__(29403);
__webpack_require__(27989);
// Map 地图核心
var Map_1 = __webpack_require__(89270);
Object.defineProperty(exports, "Map", ({ enumerable: true, get: function () { return Map_1.default; } }));
var MapApiLoaderHOC_1 = __webpack_require__(97297);
Object.defineProperty(exports, "MapApiLoaderHOC", ({ enumerable: true, get: function () { return MapApiLoaderHOC_1.default; } }));
// Control 地图控件
var MapTypeControl_1 = __webpack_require__(82190);
Object.defineProperty(exports, "MapTypeControl", ({ enumerable: true, get: function () { return MapTypeControl_1.default; } }));
var ScaleControl_1 = __webpack_require__(31126);
Object.defineProperty(exports, "ScaleControl", ({ enumerable: true, get: function () { return ScaleControl_1.default; } }));
var ZoomControl_1 = __webpack_require__(66163);
Object.defineProperty(exports, "ZoomControl", ({ enumerable: true, get: function () { return ZoomControl_1.default; } }));
var NavigationControl_1 = __webpack_require__(95448);
Object.defineProperty(exports, "NavigationControl", ({ enumerable: true, get: function () { return NavigationControl_1.default; } }));
var CityListControl_1 = __webpack_require__(45771);
Object.defineProperty(exports, "CityListControl", ({ enumerable: true, get: function () { return CityListControl_1.default; } }));
var PanoramaControl_1 = __webpack_require__(61059);
Object.defineProperty(exports, "PanoramaControl", ({ enumerable: true, get: function () { return PanoramaControl_1.default; } }));
// Overlay 覆盖物组件
var Marker_1 = __webpack_require__(4368);
Object.defineProperty(exports, "Marker", ({ enumerable: true, get: function () { return Marker_1.default; } }));
var Polyline_1 = __webpack_require__(93650);
Object.defineProperty(exports, "Polyline", ({ enumerable: true, get: function () { return Polyline_1.default; } }));
var Polygon_1 = __webpack_require__(55116);
Object.defineProperty(exports, "Polygon", ({ enumerable: true, get: function () { return Polygon_1.default; } }));
var Circle_1 = __webpack_require__(24834);
Object.defineProperty(exports, "Circle", ({ enumerable: true, get: function () { return Circle_1.default; } }));
var InfoWindow_1 = __webpack_require__(33598);
Object.defineProperty(exports, "InfoWindow", ({ enumerable: true, get: function () { return InfoWindow_1.default; } }));
var Label_1 = __webpack_require__(45412);
Object.defineProperty(exports, "Label", ({ enumerable: true, get: function () { return Label_1.default; } }));
var CustomOverlay_1 = __webpack_require__(21567);
Object.defineProperty(exports, "CustomOverlay", ({ enumerable: true, get: function () { return CustomOverlay_1.default; } }));
// Layer 图层组件
var MapvglView_1 = __webpack_require__(35575);
Object.defineProperty(exports, "MapvglView", ({ enumerable: true, get: function () { return MapvglView_1.default; } }));
var MapvglLayer_1 = __webpack_require__(30811);
Object.defineProperty(exports, "MapvglLayer", ({ enumerable: true, get: function () { return MapvglLayer_1.default; } }));
var TrafficLayer_1 = __webpack_require__(80887);
Object.defineProperty(exports, "TrafficLayer", ({ enumerable: true, get: function () { return TrafficLayer_1.default; } }));
var PanoramaLayer_1 = __webpack_require__(47955);
Object.defineProperty(exports, "PanoramaLayer", ({ enumerable: true, get: function () { return PanoramaLayer_1.default; } }));
// Library 开源工具库
var DrawingManager_1 = __webpack_require__(40902);
Object.defineProperty(exports, "DrawingManager", ({ enumerable: true, get: function () { return DrawingManager_1.default; } }));
var DistanceTool_1 = __webpack_require__(65750);
Object.defineProperty(exports, "DistanceTool", ({ enumerable: true, get: function () { return DistanceTool_1.default; } }));
// Service 地图服务
var AutoComplete_1 = __webpack_require__(85960);
Object.defineProperty(exports, "AutoComplete", ({ enumerable: true, get: function () { return AutoComplete_1.default; } }));
// Custom 自定义复杂组件
var Arc_1 = __webpack_require__(86207);
Object.defineProperty(exports, "Arc", ({ enumerable: true, get: function () { return Arc_1.default; } }));
// 其他
// @ts-ignore
exports.mapvgl = tslib_1.__importStar(__webpack_require__(53020));
tslib_1.__exportStar(__webpack_require__(8035), exports);
 ...
 */
var CityListControl = /** @class */ (function (_super) {
    tslib_1.__extends(CityListControl, _super);
    function CityListControl(props) {
        return _super.call(this, props) || this;
    }
    CityListControl.prototype.getControl = function () {
        return new BMapGL.CityListControl(this.getOptions());
    };
    CityListControl.prototype.render = function () {
        return null;
    };
    return CityListControl;
}(Control_1.default));
exports["default"] = CityListControl;
 ...
 */
var PanoramaControl = /** @class */ (function (_super) {
    tslib_1.__extends(PanoramaControl, _super);
    function PanoramaControl(props) {
        return _super.call(this, props) || this;
    }
    PanoramaControl.prototype.getControl = function () {
        var defaultOptions = {
            offset: new BMapGL.Size(30, 30),
            anchor: BMAP_ANCHOR_BOTTOM_RIGHT,
        };
        var control = new BMapGL.PanoramaControl(this.getOptions());
    ...
    PanoramaControl.prototype.render = function () {
        return null;
    };
...
var ZoomControl = /** @class */ (function (_super) {
    ...
    ZoomControl.prototype.getControl = function () {
 ...
 */
var MapTypeControl = /** @class */ (function (_super) {
    tslib_1.__extends(MapTypeControl, _super);
    function MapTypeControl(props) {
        return _super.call(this, props) || this;
    }
    MapTypeControl.prototype.getControl = function () {
        return new BMapGL.MapTypeControl(this.getOptions());
    };
    MapTypeControl.prototype.render = function () {
        return null;
    };
...
var WrapperHOC_1 = tslib_1.__importDefault(__webpack_require__(18004));
var shallowequal_1 = tslib_1.__importDefault(__webpack_require__(94104));
var isString_1 = tslib_1.__importDefault(__webpack_require__(58372));
;
var eventsMap = [
    'click',
    'dblclick',
...
var NavigationControl = /** @class */ (function (_super) {
    tslib_1.__extends(NavigationControl, _super);
    function NavigationControl(props) {
        return _super.call(this, props) || this;
    }
    NavigationControl.prototype.getControl = function () {
        return new BMapGL.NavigationControl3D(this.getOptions());
    };
    NavigationControl.prototype.render = function () {
        return null;
    };
...
var tslib_1 = __webpack_require__(29403);
var react_1 = tslib_1.__importStar(__webpack_require__(94285));
var getDisplayName_1 = tslib_1.__importDefault(__webpack_require__(76680));
/**
...
//# sourceMappingURL=5461.31f70fe1f195d9fc.js.map