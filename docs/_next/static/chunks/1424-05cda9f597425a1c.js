"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[1424],{
...
/* harmony import */ var _tms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20928);
/* harmony import */ var _fanfanlo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(77982);
 ...
 * @returns Promise
 */ async function cancelOrRemoveInvitation(invitationId, isReceived, inviteStatus) {
...
var Grid2_Grid2 = __webpack_require__(29050);
...
var Dialog_Dialog = __webpack_require__(46822);
...
var DialogTitle_DialogTitle = __webpack_require__(16880);
...
var DialogContent_DialogContent = __webpack_require__(88149);
...
var TextField_TextField = __webpack_require__(62492);
...
var DialogActions_DialogActions = __webpack_require__(89701);
...
var CircularProgress_CircularProgress = __webpack_require__(95657);
...
var src = __webpack_require__(79784);
// EXTERNAL MODULE: ./src/services/authService.ts
var services_authService = __webpack_require__(26827);
...
var report_ReportButton = __webpack_require__(71946);
...
var MeetingList = __webpack_require__(94193);
...
var styles_useTheme = __webpack_require__(72808);
...
var Paper_Paper = __webpack_require__(68732);
...
var Switch_Switch = __webpack_require__(48230);
...
var IconButton_IconButton = __webpack_require__(10184);
...
var Collapse_Collapse = __webpack_require__(68317);
...
var DialogContentText_DialogContentText = __webpack_require__(32218);
...
var Animation = __webpack_require__(37133);
...
var esm_ExpandMore = __webpack_require__(61984);
...
var Accordion_Accordion = __webpack_require__(33658);
...
var AccordionSummary_AccordionSummary = __webpack_require__(28801);
...
var AccordionDetails_AccordionDetails = __webpack_require__(78496);
...
var Divider_Divider = __webpack_require__(8536);
...
var Chip_Chip = __webpack_require__(95409);
...
var Alert_Alert = __webpack_require__(99450);
...
var List_List = __webpack_require__(66397);
...
var ListItem_ListItem = __webpack_require__(25763);
...
var Tooltip_Tooltip = __webpack_require__(44706);
...
var CheckCircle = __webpack_require__(52283);
...
var esm_Error = __webpack_require__(84981);
...
var Help = __webpack_require__(2842);
...
var Info = __webpack_require__(48257);
...
var esm_Settings = __webpack_require__(31480);
...
var FormControl_FormControl = __webpack_require__(60247);
...
var InputLabel_InputLabel = __webpack_require__(79804);
...
var DragIndicator = __webpack_require__(53100);
...
var esm_Stop = __webpack_require__(40509);
...
var esm_PlayArrow = __webpack_require__(13108);
...
var esm_Delete = __webpack_require__(22058);
...
var esm_VolumeUp = __webpack_require__(42442);
...
var Vibration = __webpack_require__(44558);
...
var ListItemText_ListItemText = __webpack_require__(83942);
...
var LinearProgress_LinearProgress = __webpack_require__(7710);
...
var Slider_Slider = __webpack_require__(32773);
...
var Snackbar_Snackbar = __webpack_require__(16430);
...
var esm_Refresh = __webpack_require__(80296);
...
var esm_InsertDriveFile = __webpack_require__(28570);
...
var MusicNote = __webpack_require__(21044);
...
var esm_Star = __webpack_require__(17993);
...
var esm_StarBorder = __webpack_require__(36443);
...
var esm_Share = __webpack_require__(25228);
...
var esm_Mic = __webpack_require__(52576);
...
var esm_CloudUpload = __webpack_require__(82355);
...
var PrivacyDialogDisplay = __webpack_require__(55453);
...
;// ./src/components/pages/home/hooks/useAutoStartPermission.tsx
...
/**
 * 自启动权限引导Hook
 * 用于在首次启用跌倒检测时显示自启动权限说明对话框
 */ function useAutoStartPermission() {
    const [autoStartDialogOpen, setAutoStartDialogOpen] = (0,react.useState)(false);
    const autoStartCallbackRef = (0,react.useRef)();
    // 检查是否需要显示自启动引导
    function checkAutoStartPermission(callback) {
        const def = {
            shown: false
        };
        const res = store/* autoJsStoreUtils */.b.read('auto_start_permission_shown', def);
        const value = res && 'shown' in res ? res : def;
        // 已经显示过了
        if (value.shown) {
            callback();
            return;
        ...
        // 需要弹出自启动引导
        autoStartCallbackRef.current = callback;
        setAutoStartDialogOpen(true);
    }
    // 处理自启动引导对话框
    const handleAutoStartDialog = (agreed)=>{
        console.log('[自启动引导] 用户选择:', agreed ? '同意' : '暂不开启');
        // 保存用户选择
        try {
            const script = "\n                var EmergencySettings = Packages.com.fanfanlo.droid.utils.EmergencySettings;\n                var context = com.fanfanlo.lib.mc.LibMainModel.instance.application;\n                EmergencySettings.setAutoStartEnabled(context, ".concat(agreed, ");\n                EmergencySettings.setAutoStartPermissionShown(context);\n            ");
            AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            console.log('[自启动引导] 设置已保存');
        } catch (error) {
            console.error('[自启动引导] 保存设置失败:', error);
        }
        // 标记已显示
        store/* autoJsStoreUtils */.b.write('auto_start_permission_shown', {
            shown: true
        });
        setAutoStartDialogOpen(false);
        // 继续启动监控
        if (autoStartCallbackRef.current) {
            autoStartCallbackRef.current();
        }
    };
    // 自启动引导对话框组件
    const AutoStartDialog = ()=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(Dialog_Dialog/* default */.A, {
            open: autoStartDialogOpen,
            onClose: ()=>handleAutoStartDialog(false),
            "aria-labelledby": "auto-start-dialog-title",
            "aria-describedby": "auto-start-dialog-description",
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogTitle_DialogTitle/* default */.A, {
                    id: "auto-start-dialog-title",
                    children: "开机自启动权限说明"
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContent_DialogContent/* default */.A, {
                    children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogContentText_DialogContentText/* default */.A, {
                        id: "auto-start-dialog-description",
                        children: [
                            "为了确保紧急保护功能能够持续工作，我们需要您的授权：",
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("br", {}),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("br", {}),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("strong", {
                                children: "【开机自启动功能】"
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogActions_DialogActions/* default */.A, {
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                            onClick: ()=>handleAutoStartDialog(false),
                            children: "暂不开启"
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                            onClick: ()=>handleAutoStartDialog(true),
                            autoFocus: true,
                            variant: "contained",
                            children: "允许"
                        })
...
const FallDetectionWrapper = (param)=>{
    ...
    // 通知权限相关状态
    const [notificationPermissionDialogOpen, setNotificationPermissionDialogOpen] = (0,react.useState)(false);
    const notificationPermissionCallbackRef = (0,react.useRef)();
    // 自启动权限引导Hook
    const { checkAutoStartPermission, AutoStartDialog } = useAutoStartPermission();
    ...
    function checkNotificationPermission(callback) {
        console.log('[跌倒检测] 检查通知权限');
        try {
            // 先检查当前通知权限状态
            const checkScript = "\n                var result = com.fanfanlo.emergencycall.manager.PermissionJSInterface.checkNotificationPermission();\n                result;\n            ";
            const { javaResultString } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(checkScript);
            console.log('[跌倒检测] 通知权限检查结果:', javaResultString);
            if (javaResultString) {
                const checkResult = JSON.parse(javaResultString);
                if (checkResult.error) {
                    console.error('[跌倒检测] 检查通知权限出错:', checkResult.error);
                    callback(true); // 出错时默认通过
                    return;
                }
                if (checkResult.granted) {
                    console.log('[跌倒检测] 通知权限已授权');
                    callback(true);
                    return;
                }
                // 通知权限未授权
                console.log('[跌倒检测] 通知权限未授权, canRequestInApp:', checkResult.canRequestInApp);
                if (checkResult.canRequestInApp) {
                    // Android 13+: 直接请求权限（会弹出系统对话框）
                    console.log('[跌倒检测] Android 13+, 直接请求通知权限');
                    const requestScript = "\n                        com.fanfanlo.emergencycall.manager.PermissionJSInterface.requestNotificationPermission();\n                    ";
                    AutoWebViewJs/* autoWebViewJs */.yx.callScript(requestScript);
                    // 请求后回调false，让用户再次点击开关（因为无法同步获取权限请求结果）
                    callback(false);
                } else {
                    // Android 12及以下: 显示引导对话框
                    console.log('[跌倒检测] Android 12及以下, 显示引导对话框');
                    notificationPermissionCallbackRef.current = callback;
                    setNotificationPermissionDialogOpen(true);
                }
            } else {
                console.log('[跌倒检测] 获取通知权限状态返回空，跳过检查');
                callback(true);
            }
        } catch (error) {
            console.error('[跌倒检测] 检查通知权限失败:', error);
            callback(true); // 出错时默认通过
        }
    }
    // 处理通知权限对话框（Android 12及以下使用）
    const handleNotificationPermissionDialog = (goToSettings)=>{
        setNotificationPermissionDialogOpen(false);
        if (goToSettings) {
            console.log('[跌倒检测] 用户选择去设置页面开启通知权限');
            try {
                const script = 'com.fanfanlo.emergencycall.manager.PermissionJSInterface.openPermissionSettings("notification");';
                AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            } catch (error) {
                console.error('[跌倒检测] 打开通知权限设置页面失败:', error);
            }
        }
        // 无论用户选择什么，都回调false，让用户手动再次点击开关
        if (notificationPermissionCallbackRef.current) {
            notificationPermissionCallbackRef.current(false);
        }
    };
                ...
                if (REQUIRE_LOGIN_FOR_FALL_DETECTION) {
                    ...
                    services_authService/* authService */.y.showLoginDialog().then((appLoggedIn)=>{
                        ...
                        checkShowFallInfo((permissionPassed)=>{
                            ...
                            // 4. 检查是否需要显示自启动引导
                            console.log('[跌倒检测] 步骤4: 检查自启动引导');
                            checkAutoStartPermission(()=>{
                                // 5. 检查通知权限
                                console.log('[跌倒检测] 步骤5: 检查通知权限');
                                checkNotificationPermission((notificationPassed)=>{
                                    console.log('[跌倒检测] 通知权限检查结果:', notificationPassed ? '已授权' : '未授权');
                                    if (!notificationPassed) {
                                        console.log('[跌倒检测] 通知权限未授权，终止启动');
                                        return;
                                    }
                                    try {
                    ...
                    checkShowFallInfo((permissionPassed)=>{
                        ...
                        // 检查是否需要显示自启动引导
                        console.log('[跌倒检测] 步骤3: 检查自启动引导(无登录)');
                        checkAutoStartPermission(()=>{
                            // 4. 检查通知权限
                            console.log('[跌倒检测] 步骤4: 检查通知权限(无登录)');
                            checkNotificationPermission((notificationPassed)=>{
                                console.log('[跌倒检测] 通知权限检查结果(无登录):', notificationPassed ? '已授权' : '未授权');
                                if (!notificationPassed) {
                                    console.log('[跌倒检测] 通知权限未授权(无登录)，终止启动');
                                    return;
                                }
                                try {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Paper_Paper/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(AutoStartDialog, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Dialog_Dialog/* default */.A, {
                open: notificationPermissionDialogOpen,
                onClose: ()=>handleNotificationPermissionDialog(false),
                "aria-labelledby": "notification-permission-dialog-title",
                "aria-describedby": "notification-permission-dialog-description",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogTitle_DialogTitle/* default */.A, {
                        id: "notification-permission-dialog-title",
                        children: "需要开启通知权限"
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContent_DialogContent/* default */.A, {
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContentText_DialogContentText/* default */.A, {
                            id: "notification-permission-dialog-description",
                            children: "跌倒检测功能需要通知权限才能正常工作。当检测到跌倒时，系统需要通过通知提醒您和紧急联系人。请前往设置页面开启通知权限。"
                        })
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogActions_DialogActions/* default */.A, {
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                                onClick: ()=>handleNotificationPermissionDialog(false),
                                children: "稍后再说"
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                                onClick: ()=>handleNotificationPermissionDialog(true),
                                autoFocus: true,
                                children: "去设置"
                            })
                        ]
...
var components_AddWidgetButton = __webpack_require__(19965);
...
var Avatar = __webpack_require__(65140);
...
var CardActions = __webpack_require__(59319);
...
var AccessTime = __webpack_require__(65050);
...
var Check = __webpack_require__(5415);
...
var list_all_invitations = __webpack_require__(39026);
// EXTERNAL MODULE: ../../libs/app/model/src/mc/app/AppModel.ts
var AppModel = __webpack_require__(11862);
 ...
 */ function PrivacyDialogAuto(param) {
    ...
    (0,react.useEffect)(()=>{
        ...
        console.log("".concat(LOG_TAG, " PrivacyDialogAuto useEffect start, type=").concat(type, ", isRealInAndroid=").concat(is_in_android/* isRealInAndroid */.nd));
        // web中也可以调试
        const def = {
            agree: is_in_android/* isRealInAndroid */.nd ? false : true,
            disagreeTime: 0
        };
        console.log("".concat(LOG_TAG, " PrivacyDialogAuto default value=").concat(JSON.stringify(def)));
        const res = store/* autoJsStoreUtils */.b.read("privacy_".concat(type), def);
        console.log("".concat(LOG_TAG, " PrivacyDialogAuto read result=").concat(JSON.stringify(res)));
        const value = res && 'agree' in res ? res : def;
        console.log("".concat(LOG_TAG, " PrivacyDialogAuto final value=").concat(JSON.stringify(value)));
        ...
        if (autoOpened) {
            //自动检测已经弹出过了就不再弹了
            console.log("".concat(LOG_TAG, " PrivacyDialogAuto skip: autoOpened=true"));
            return;
        }
        // 不在Android环境中不弹出
        // if (!isRealInAndroid) {
        ...
        if (value.agree) {
            ...
            console.log("".concat(LOG_TAG, " PrivacyDialogAuto skip: already agreed"));
            return;
        }
        // 在冷却期内（拒绝后3天内），不弹出
        if (value.disagreeTime && value.disagreeTime != 0 && value.disagreeTime + 3 * 24 * 60 * 60 * 1000 > Date.now()) {
            ...
            console.log("".concat(LOG_TAG, " PrivacyDialogAuto skip: in cooldown period"));
            return;
        }
        effLog.log('setOpen=true');
        console.log("".concat(LOG_TAG, " PrivacyDialogAuto setOpen=true, will show dialog"));
        // 满足条件，弹出隐私协议
        setOpen(true);
    }, [
        type
...
var FontSizeContext = __webpack_require__(61921);
...
//# sourceMappingURL=1424-05cda9f597425a1c.js.map