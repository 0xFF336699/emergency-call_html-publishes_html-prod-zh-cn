...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/ListItemIcon/ListItemIcon.js
var ListItemIcon = __webpack_require__(19069);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Cancel.js
var Cancel = __webpack_require__(91306);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Sensors.js
var Sensors = __webpack_require__(95519);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Groups.js
var Groups = __webpack_require__(23972);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Person.js
var Person = __webpack_require__(94177);
;// ../../libs/app/model/src/remote/permission/status.ts


// 获取相关用户权限状态 API 客户端
async function getRelatedPermissions() {
    ...
    return (0,request/* request */.Em)({
        t: tms/* tms */.X.TPermission,
        m: tms/* tms */.X.MPermissionGetRelatedPermissions,
        p: defaultParams
    });
}

;// ./src/components/unified-monitoring-control/UnifiedMonitoringControl.tsx
...
const UnifiedMonitoringControl = ()=>{
    ...
    const [dialogCallback, setDialogCallback] = (0,react.useState)(null);
    // 权限状态相关state
    const [permissionExpanded, setPermissionExpanded] = (0,react.useState)(false);
    const [keepExpanded, setKeepExpanded] = (0,react.useState)(false);
    const [permissionData, setPermissionData] = (0,react.useState)([]);
    const [selfPermissionData, setSelfPermissionData] = (0,react.useState)(null);
    const [permissionLoading, setPermissionLoading] = (0,react.useState)(false);
    const [lastBackendUpdate, setLastBackendUpdate] = (0,react.useState)(0);
    const [lastSelfUpdate, setLastSelfUpdate] = (0,react.useState)(0);
    // 初始化：获取Android端状态
    (0,react.useEffect)(()=>{
        loadInitialState();
    }, []);
    ...
    const loadInitialState = async ()=>{
        try {
            ...
            const { javaResultString: sensorResult } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(sensorScript);
            ...
            const { javaResultString: thresholdResult } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(thresholdScript);
    ...
    const getPermissionIcon = (status)=>{
        switch(status === null || status === void 0 ? void 0 : status.toLowerCase()){
            ...
            case 'denied':
            case 'low':
                return /*#__PURE__*/ (0,jsx_runtime.jsx)(Cancel/* default */.A, {
                    color: "error"
                });
            case 'medium':
    ...
    // 渲染权限列表项
    const renderPermissionItem = function(permission) {
        let isAndroidData = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        const status = isAndroidData ? permission.level : permission.camera_status || permission.microphone_status || permission.location_status || permission.overlay_status || permission.battery_optimization_status || permission.notification_status || permission.screen_on_status || permission.overall_status;
        return /*#__PURE__*/ (0,jsx_runtime.jsxs)(ListItem/* default */.Ay, {
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemText/* default */.A, {
                    primary: isAndroidData ? formatPermissionType(permission.permission_type) : permission.user_name || "用户 ".concat(permission.user_id),
                    secondary: isAndroidData ? "状态: ".concat(status, " | ").concat(permission.description) : "总体状态: ".concat(permission.overall_status, " | 最后检查: ").concat(permission.last_check_time ? new Date(permission.last_check_time).toLocaleString() : '未知')
                })
            ]
        }, isAndroidData ? permission.permission_type : permission.user_id);
    };
    const handleSetThreshold = ()=>{
        ...
        try {
            ...
            alert("震动阈值已设置为: ".concat(thresholdValue));
        } catch (error) {
    ...
    const startMonitoring = ()=>{
        try {
            // 调用统一的启动方法
            const script = "\n        com.fanfanlo.emergencycall.manager.SensorManager.startUnifiedMonitoring(".concat(state.sensorEnabled, ", ").concat(state.permissionEnabled, ");\n      ");
            AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            setState((prev)=>({
                    ...prev,
                    isRunning: true
    ...
    const checkForegroundServicePermission = (callback)=>{
    ...
    const handleSensorToggle = (enabled)=>{
        setState((prev)=>({
                ...prev,
                sensorEnabled: enabled
            }));
    };
    const handlePermissionToggle = (enabled)=>{
        setState((prev)=>({
                ...prev,
    ...
    const getStatusChips = ()=>{
        ...
        if (state.sensorEnabled) {
            chips.push(/*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(Sensors/* default */.A, {}),
                label: "传感器监控",
                color: "primary",
                size: "small"
            }, "sensor"));
        ...
        if (state.permissionEnabled) {
            chips.push(/*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(Security/* default */.A, {}),
                label: "权限监控",
                color: "secondary",
                size: "small"
            }, "permission"));
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Paper/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                        ...
                        children: [
                            getStatusChips(),
                            !state.sensorEnabled && !state.permissionEnabled && /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                                label: "未选择监控功能",
                                color: "default",
                                size: "small"
                            })
                        ...
                        label: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                    variant: "subtitle2",
                                    children: [
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Sensors/* default */.A, {
                                            sx: {
                                ...
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                                    variant: "body2",
                                    color: "text.secondary",
                                    children: "监控设备加速度和陀螺仪数据，检测摔倒事件"
                                })
                            ]
                        })
                    }),
                    state.sensorEnabled && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                        sx: {
                            ml: 4,
                            mt: 1,
                            display: 'flex',
            ...
            state.permissionEnabled && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Accordion/* default */.A, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(AccordionSummary/* default */.A, {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                            ...
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Groups/* default */.A, {}),
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                                    variant: "subtitle2",
                                    children: "权限状态监控"
                                }),
                                permissionLoading && /*#__PURE__*/ (0,jsx_runtime.jsx)(CircularProgress/* default */.A, {
                                    size: 16
                                }),
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
                                    sx: {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(AccordionDetails/* default */.A, {
                        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                            children: [
                                selfPermissionData && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                                    sx: {
                                        mb: 2
                                    },
                                    children: [
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Person/* default */.A, {}),
                                                "我的权限状态",
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                                                    label: "总体: ".concat(selfPermissionData.overall_status),
                                                    size: "small",
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(List/* default */.A, {
                                            dense: true,
                                            children: selfPermissionData.permissions.map((permission)=>renderPermissionItem(permission, true))
                                        }),
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                            variant: "caption",
                                            color: "text.secondary",
                                            children: [
                                                "最后更新: ",
                                                lastSelfUpdate ? new Date(lastSelfUpdate).toLocaleString() : '未更新',
                                                " (每分钟刷新)"
                                            ]
                                        })
                                    ]
                                }),
                                permissionData.length > 0 && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                                    children: [
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                            variant: "subtitle2",
                                            sx: {
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(List/* default */.A, {
                                            dense: true,
                                            children: permissionData.map((permission)=>renderPermissionItem(permission, false))
                                        }),
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                            variant: "caption",
                                            color: "text.secondary",
                                            children: [
                                                "最后更新: ",
                                                lastBackendUpdate ? new Date(lastBackendUpdate).toLocaleString() : '未更新',
                                                " (每5分钟刷新)"
                                            ]
                                        })
                                    ]
                                }),
                                permissionData.length === 0 && !selfPermissionData && !permissionLoading && /*#__PURE__*/ (0,jsx_runtime.jsx)(Alert/* default */.A, {
                                    severity: "info",
                                    children: "暂无权限数据。请确保权限监控已启用且有联系人数据。"
                                })
                            ]
                        })
                    })
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                        ...
                        fullWidth: true,
                        startIcon: state.isRunning ? /*#__PURE__*/ (0,jsx_runtime.jsx)(Stop/* default */.A, {}) : /*#__PURE__*/ (0,jsx_runtime.jsx)(PlayArrow/* default */.A, {}),
                        disabled: !state.isRunning && !state.sensorEnabled && !state.permissionEnabled,
                        children: state.isRunning ? '停止监控' : '开始监控'
                    })
                })
            }),
            !state.sensorEnabled && !state.permissionEnabled && /*#__PURE__*/ (0,jsx_runtime.jsx)(Alert/* default */.A, {
                severity: "info",
                sx: {
                    mt: 2
                },
                children: "请至少选择一种监控功能：传感器监控用于摔倒检测，权限监控确保紧急功能可用。"
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Dialog/* default */.A, {
                open: dialogOpen,
                onClose: ()=>dialogCallback === null || dialogCallback === void 0 ? void 0 : dialogCallback.onCancel(),
                "aria-labelledby": "foreground-service-dialog-title",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogTitle/* default */.A, {
                        id: "foreground-service-dialog-title",
                        children: "启用前台服务通知"
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogContent/* default */.A, {
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContentText/* default */.A, {
                                children: "为了在应用退到后台后仍能持续监控传感器数据和权限状态，我们需要启用一个前台服务。 这会在您的设备通知栏显示一个持续的通知。您是否同意？"
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                                sx: {
                                    mt: 2
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                                        ...
                                        children: [
                                            state.sensorEnabled && /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                                                icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(Sensors/* default */.A, {}),
                                                label: "传感器监控",
                                                size: "small",
                                                sx: {
                                            ...
                                            state.permissionEnabled && /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                                                icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(Security/* default */.A, {}),
                                                label: "权限监控",
                                                size: "small",
                                                sx: {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogActions/* default */.A, {
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                                onClick: ()=>dialogCallback === null || dialogCallback === void 0 ? void 0 : dialogCallback.onCancel(),
                                children: "不同意"
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                                onClick: ()=>dialogCallback === null || dialogCallback === void 0 ? void 0 : dialogCallback.onPassed(),
                                autoFocus: true,
                                variant: "contained",
                                children: "同意"
                            })
...
/* harmony default export */ const unified_monitoring_control_UnifiedMonitoringControl = ((/* unused pure expression or super */ null && (UnifiedMonitoringControl)));

;// ./src/components/unified-monitoring-control/index.ts
                        ...
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
                            ...
                            children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                ...
                                children: [
                                    ...
                                    "• 启用后，紧急呼救将使用TTS语音代替默认音频",
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("br", {}),
                                    "• 请设置简洁明了的呼救文字，确保在紧急情况下能清楚传达",
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("br", {}),
                                    "• 建议先测试语音效果，确认语速和音调适中",
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("br", {}),
                                    "• 重复间隔设置过短可能影响语音清晰度"
...
function Content() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(UnifiedMonitoringControl, {}),
...
//# sourceMappingURL=573-5723e04628cf903f.js.map