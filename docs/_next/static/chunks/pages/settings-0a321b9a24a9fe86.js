...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/settings",
      function () {
        return __webpack_require__(89440);
      }
    ]);
    if(false) {}
...
;// ./src/components/pages/settings/content/app-version/AppVersion.tsx




function getVersion() {
    const script = "\n    var version = -1;\n    try{\n        var context = com.fanfanlo.lib.mc.libMainModel.application;\n        packageInfo = context.packageManager.getPackageInfo(context.packageName, 0)\n        version = packageInfo.longVersionCode\n    }catch(e){\n    }\n    \n    version;\n    ";
    const script2 = "\n    var version = com.fanfanlo.emergencycall.utils.AppUtils.getAppVersionCode();\n    version;\n    ";
    const script3 = "\n    \n        var context = com.fanfanlo.lib.mc.libMainModel.application.applicationContext;\n        packageInfo = context.packageManager.getPackageInfo(context.packageName, 0)\n        var version = packageInfo.longVersionCode;\n        version;\n    ";
    const { javaResultString } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script2);
    console.log('vvvvvvvvvvvvvvvvvvvv32v2', javaResultString);
    return javaResultString || "0";
}
function AppVersion() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        children: [
            ...
            !isNew && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
...
const SettingsContent = ()=>{
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(PrivacyDialogAuto/* PrivacyDialogAuto */.S, {
                type: "main",
                area: "zh-cn"
            }),
...
/******/ __webpack_require__.O(0, [415,2092,7097,3648,636,6593,8792], () => (__webpack_exec__(45520)));
