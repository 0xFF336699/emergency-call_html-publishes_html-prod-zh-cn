(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[469],{
...
function MeetingRoomComponent(param, ref) {
    ...
    const connectToRoom = (0,react.useCallback)(async ()=>{
        ...
        try {
            ...
            uiLogger.log("连接到房间: ".concat(livekitConfig.jwt, ", 房间名: ").concat(roomName, ", 身份: ").concat(userName, ", 角色: ").concat(role));
            ...
            // 6. 发布本地轨道（安全接收者不发布音视频）
            if (role !== 'security_receiver') {
                try {
                    await Promise.all([
                ...
                // 安全接收者模式：不发布本地音视频轨道，但不停止它们
                // 这样可以保持接收远程参与者的音视频流
                uiLogger.log('安全接收者模式：不发布本地音视频，但保持接收能力');
                // 静音本地轨道但不停止，这样仍然可以接收远程流
                await audioTrack.mute();
                await videoTrack.mute();
            }
            // 8. 更新引用和状态
            ...
            updateParticipantState(room.localParticipant.identity, {
                isAudioEnabled: role === 'security_receiver' ? false : initialAudioEnabled,
                isVideoEnabled: role === 'security_receiver' ? false : initialVideoEnabled,
                audioTrack: role === 'security_receiver' ? null : audioTrack,
                videoTrack: role === 'security_receiver' ? null : videoTrack
            });
            // 10. 为现有远程参与者设置轨道
...
/******/ __webpack_require__.O(0, [262,924,6,636,593,792], () => (__webpack_exec__(53692)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=join-call-c678c20575fbca03.js.map