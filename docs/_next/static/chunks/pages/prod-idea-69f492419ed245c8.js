(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[4977],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/utils/createSvgIcon.js + 2 modules
var createSvgIcon = __webpack_require__(61541);
;// ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Healing.js
/* __next_internal_client_entry_do_not_use__ default auto */ 

/* harmony default export */ const Healing = ((0,createSvgIcon/* default */.A)(/*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
...
;// ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/MonetizationOn.js
/* __next_internal_client_entry_do_not_use__ default auto */ 

/* harmony default export */ const MonetizationOn = ((0,createSvgIcon/* default */.A)(/*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
...
;// ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Public.js
/* __next_internal_client_entry_do_not_use__ default auto */ 

/* harmony default export */ const Public = ((0,createSvgIcon/* default */.A)(/*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
...
;// ./src/components/pages/prod-idea/Content.tsx
...
const docData = {
    ...
    future: [
        {
            icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(Healing, {
                color: "primary"
            }),
            title: "健康与流量模块",
            points: [
                "初期以有特色的小众健康场景为主，例如社区健康活动、康复训练课程。",
                "通过健康场景吸引早期用户，形成可观活跃度。",
                "逐步抽象至更大用户基数的内容，例如常规健康管理、线上健康课程、健康打卡社群。",
                "鼓励老年用户参与探店、娱乐、养生交流，激发老年人大V模态。",
                "通过直播买菜或社区活动增加近场社交互动，并提升安全监护时效。",
                "初期目标偏老人群体，利用UGC内容激活社区互动，避免大量音视频内容起步难。",
                "海外市场可根据发达国家或高收入地区特点选择，消费能力、技术接受度和网络基础设施更适合带货模式。"
            ]
        },
        {
            icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(MonetizationOn, {
                color: "secondary"
            }),
            title: "广告收益代理模式",
            points: [
                "预售城市或区县的广告收益权，形式类似众筹或投资。",
                "投资方可选择自投广告，或坐享广告位分成。",
                "可与保安、地铁、红十字等系统合作，给予未来收益作为激励。"
            ]
        },
        {
            icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(Public, {
                color: "info"
            }),
            title: "海外市场与地区版本",
            points: [
                "海外市场可能从具体单一市场逐步扩张，也可能采取覆盖大区域如欧洲的版本策略。",
                "针对欧洲的不同语言和监管情况，可能需要特定地区版本。",
                "UGC内容在国外监管一般比国内宽松，但仍需遵守当地法律和平台政策。"
            ]
        }
    ],
    flowDiagram: {
...
function Bullets(param) {
    let { items } = param;
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Stack/* default */.A, {
        spacing: 1,
        children: items.map((t, i)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                variant: "body2",
                sx: {
                    ml: 2,
                    lineHeight: 1.6
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Paper/* default */.A, {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                variant: "h6",
                gutterBottom: true,
                children: docData.flowDiagram.title
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Stack/* default */.A, {
                direction: "column",
                spacing: 4,
                justifyContent: "flex-start",
                children: docData.flowDiagram.steps.map((s, i)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(Card/* default */.A, {
                        sx: {
                            p: 2,
                            borderRadius: 2,
                            backgroundColor: '#fff',
...
function Document() {
    (0,react.useEffect)(()=>{
        window.document.title = docData.title;
    }, []);
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
                spacing: 5,
                children: [
                    docData.future.map((f, i)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(Paper/* default */.A, {
                            sx: {
                                p: 3,
                                borderRadius: 3,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Bullets, {
                                    items: f.points
                                })
                            ]
                        }, i)),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(FlowDiagram, {})
                ]
            })
        ]
    });
    ...
    return /*#__PURE__*/ _jsxs(Box, {
        children: [
            ...
            /*#__PURE__*/ _jsxs(Box, {
                children: [
                    /*#__PURE__*/ _jsx(Box, {
                        children: "预售各个城市或区县的广告收益，也可以是他自己投放广告，可能收取的钱偏少，但是具体需要讨论后再定。"
                    }),
                    /*#__PURE__*/ _jsx(Box, {
                        children: "这部分钱类似于众筹创业募集资金的方式。未来如果成了，投资者会收益很丰厚。"
                    })
                ]
            }),
            /*#__PURE__*/ _jsx(Box, {
                children: "给我们支持的合作伙伴也可以赠与一些这样的条件，例如如果拿下北京的红十字、保安、地铁等，我们可以给未来几年的收益。"
            }),
            /*#__PURE__*/ _jsx(Box, {
                children: "这些收益可以是城市、区县的某个阶段的收益，例如北京东城区2028年1-6月份的广告投入/广告收益权等。广告可以由受益人自行决定投放哪些，例如直播、健康培训等。"
            })
        ]
    });
}
function prod_idea_Security() {
    return /*#__PURE__*/ _jsxs(Box, {
        children: [
            /*#__PURE__*/ _jsx(Box, {
                children: "纳入保安、地铁服务、红十字系统"
            }),
            /*#__PURE__*/ _jsx(Box, {
                children: "这行业内有很多人受过急救培训，可以在危急时刻在安全和医疗方面进行增援。"
            })
        ]
    });
}
function ProdIdea() {
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Box_Box/* default */.A, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Document, {})
    });
}
...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/prod-idea",
      function () {
        return __webpack_require__(40283);
      }
    ]);
    if(false) {}
...
/******/ __webpack_require__.O(0, [636,6593,8792], () => (__webpack_exec__(51668)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=prod-idea-69f492419ed245c8.js.map