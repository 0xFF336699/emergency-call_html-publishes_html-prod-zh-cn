...
const ShakeConfigUI = ()=>{
   ...
   */ const validateConfig = (config)=>{
        return config.shakeCount >= 1 && config.shakeCount <= 10 && config.timeWindowMs > 0 && config.timeWindowMs <= 10000 && [
            'medical',
            'security'
        ].includes(config.emergencyType) && [
            'low',
            'medium',
            'high'
        ].includes(config.sensitivity) && config.version > 0;
    };
    /**
   * 保存配置到Android端
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                        ...
                        children: [
                            lastSaveTime && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                variant: "caption",
                                color: "text.secondary",
                                children: [
                                    "已保存 ",
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(IconButton/* default */.A, {
                                size: "small",
                                children: isExpanded ? /*#__PURE__*/ (0,jsx_runtime.jsx)(ExpandLess/* default */.A, {}) : /*#__PURE__*/ (0,jsx_runtime.jsx)(ExpandMore/* default */.A, {})
                            })
                        ]
                    })
                ]
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Collapse/* default */.A, {
                in: isExpanded,
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Divider/* default */.A, {}),
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                        ...
                        children: [
                            !isLoggedIn && /*#__PURE__*/ (0,jsx_runtime.jsx)(Alert/* default */.A, {
                                severity: "warning",
                                sx: {
                                    mb: 2
                                },
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(FormControl/* default */.A, {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Select/* default */.A, {
                                                ...
                                                children: emergencyTypeOptions.map((option)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(MenuItem/* default */.A, {
                                                        value: option.value,
                                        ...
                                        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(FormControl/* default */.A, {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Select/* default */.A, {
                                                    ...
                                                    children: sensitivityOptions.map((option)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(MenuItem/* default */.A, {
                                                            value: option.value,
                                                            children: option.label
                                                        }, option.value))
                                                })
                                ...
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(FormControlLabel/* default */.A, {
                                        control: /*#__PURE__*/ (0,jsx_runtime.jsx)(Switch/* default */.A, {
                                            ...
                                            onChange: (e)=>updateConfig({
                                                    enablePreAlarm: e.target.checked
                                                }),
                                            disabled: !config.enabled || !isLoggedIn
                                        }),
                                        label: "启用预报警"
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("ul", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)("li", {
                                                    children: config.enablePreAlarm ? '启用预警将给您10秒钟确认或取消' : '禁用预警将立即触发报警'
                                                })
                                            ]
                                        })
                                    ]
...
/* harmony default export */ const shakeconfig_ShakeConfigUI = (ShakeConfigUI);
...
function Content() {
    ...
    react.useEffect(()=>{
        (0,Preload/* nextPreload */.h)(router, '/intro');
        (0,Preload/* nextPreload */.h)(router, '/how-to-use');
    }, []);
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        sx: {
            my: 2,
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(shakeconfig_ShakeConfigUI, {}),
...
//# sourceMappingURL=6681-46078d31a67faea2.js.map