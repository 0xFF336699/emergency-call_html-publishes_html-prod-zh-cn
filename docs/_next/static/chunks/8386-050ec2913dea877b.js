"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[8386],{
...
var useScrollTrigger = __webpack_require__(47262);
...
var Slide = __webpack_require__(21668);
...
var Fade = __webpack_require__(68362);
...
var CssBaseline = __webpack_require__(72632);
...
var AppBar_AppBar = __webpack_require__(90832);
...
var Toolbar_Toolbar = __webpack_require__(55095);
...
var Fab = __webpack_require__(37914);
// EXTERNAL MODULE: ../../libs/fanfanlo/src/utils/browser/window-history-utils.ts
var window_history_utils = __webpack_require__(65249);
...
var KeyboardArrowLeft = __webpack_require__(53296);
...
var KeyboardArrowUp = __webpack_require__(65900);
...
var AnimatePresence = __webpack_require__(5239);
...
var proxy = __webpack_require__(63664);
...
function PageShell(param) {
    ...
    (0,react.useEffect)(()=>{
        ...
        const unlisten = static_model/* staticModel */.y.listenSwitchPage(()=>{
            if (!box) return;
        });
        if (!box) return;
        box.addEventListener("click", (e)=>{
            if (static_model/* staticModel */.y.screenLockCount == 0) return;
            e.stopPropagation();
            e.preventDefault();
        });
        return ()=>{
...
var AndroidPageContent = __webpack_require__(60471);
...
function ScrollTop(props) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Fade/* default */.A, {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
            "data-testid": "AppBar__scrollTopContainer__01aryz6s610p4z0skjq69x5prf",
            "data-test-comment": "滚动到顶部容器，当页面向下滚动超过100px时显示",
            onClick: handleClick,
            role: "presentation",
            sx: {
                position: 'fixed',
            ...
            children: [
                        ...
                        children: appbarProps.toolbar ? appbarProps.toolbar : /*#__PURE__*/ (0,jsx_runtime.jsxs)(Toolbar_Toolbar/* default */.A, {
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(IconButton/* default */.A, {
                                    "data-testid": "page-back-0uwi27ww",
                                    "data-test-comment": "返回按钮，点击后返回上一页面",
                                    onClick: handleBack,
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(KeyboardArrowLeft/* default */.A, {})
                                }),
                                appbarProps.title
                            ]
                        })
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(ScrollTop, {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Fab/* default */.A, {
                        ...
                        "data-testid": "AppBar__scrollToTopButton__01aryz6s610p4z0skjq69x5pre",
                        "data-test-comment": "滚动到顶部按钮，点击后平滑滚动到页面顶部",
...
//# sourceMappingURL=8386-050ec2913dea877b.js.map